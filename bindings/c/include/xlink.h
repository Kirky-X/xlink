#ifndef XLINK_C_BINDINGS_H
#define XLINK_C_BINDINGS_H
...
typedef enum {
    XLINK_PRIORITY_LOW = 0,
    XLINK_PRIORITY_NORMAL = 1,
    XLINK_PRIORITY_HIGH = 2,
    XLINK_PRIORITY_CRITICAL = 3
} xlink_priority_t;
